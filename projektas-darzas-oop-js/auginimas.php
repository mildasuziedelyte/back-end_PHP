...
<head>
    ...
    <script src="http://localhost/back-end_PHP/projektas-darzas-oop-js/js/appA.js" defer ></script>
    <script> const apiURL = 'http://localhost/back-end_PHP/projektas-darzas-oop-js/auginimas';</script>
</head>
<body>
